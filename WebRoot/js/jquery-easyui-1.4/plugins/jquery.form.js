...
(function($) {
	function _1(_2, _3) {
		...
		var _7 = $("<iframe id=" + _6 + " name=" + _6 + "></iframe>")
				.appendTo("body");
		_7.attr("src", window.ActiveXObject
						? "javascript:false"
						: "about:blank");
		_7.css({
					position : "absolute",
		...
		function _8(_9) {
			...
			try {
				for (var n in _9) {
					var _c = $("<input type=\"hidden\" name=\"" + n + "\">")
							.val(_9[n]).appendTo(_a);
					_b = _b.add(_c);
				}
				_d();
				_a[0].submit();
	...
	function _11(_12, _13) {
		...
		function _1b(_1f, val) {
			var rr = $(_12).find("input[name=\"" + _1f
					+ "\"][type=radio], input[name=\"" + _1f
					+ "\"][type=checkbox]");
	...
	function _25(_26) {
		...
		var t = $(_26);
		var _29 = ["textbox", "combo", "combobox", "combotree", "combogrid",
				"slider"];
	...
	function _2c(_2d) {
		_2d.reset();
		var t = $(_2d);
		var _2e = ["textbox", "combo", "combobox", "combotree", "combogrid",
	...
	function _33(_3a, _3b) {
		...
		_3c.novalidate = _3b;
		$(_3a).find(".validatebox-text:not(:disabled)").validatebox(_3b
				? "disableValidation"
				: "enableValidation");
	};
