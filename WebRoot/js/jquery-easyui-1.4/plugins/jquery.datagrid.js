...
(function($) {
	...
	function _4f(_50, _51) {
		...
		var _56 = $("<div class=\"datagrid-wrap\">"
		...
		return {
			...
			dc : {
				...
				view1 : _58,
				view2 : _59,
				header1 : _58.children("div.datagrid-header")
						.children("div.datagrid-header-inner"),
				header2 : _59.children("div.datagrid-header")
						.children("div.datagrid-header-inner"),
				body1 : _58.children("div.datagrid-body")
						.children("div.datagrid-body-inner"),
				body2 : _59.children("div.datagrid-body"),
				footer1 : _58.children("div.datagrid-footer")
						.children("div.datagrid-footer-inner"),
				footer2 : _59.children("div.datagrid-footer")
						.children("div.datagrid-footer-inner")
			}
		};
	};
			...
			if ($.isArray(_5d.toolbar)) {
				...
				for (var i = 0; i < _5d.toolbar.length; i++) {
					...
					if (btn == "-") {
						...
						var _63 = $("<a href=\"javascript:void(0)\"></a>")
								.appendTo(td);
		...
		if (_5d.pagination) {
			...
			if (_5d.pagePosition == "bottom") {
				...
				if (_5d.pagePosition == "top") {
					...
					var _65 = $("<div class=\"datagrid-pager datagrid-pager-top\"></div>")
							.prependTo(_5e);
					_64.appendTo(_5e);
					_64 = _64.add(_65);
				}
	...
	function _75(_76) {
		...
		_7b.unbind(".datagrid").bind("click.datagrid", function(e) {
			...
			var p1 = $(this).offset().left + 5;
			var p2 = $(this).offset().left + $(this)._outerWidth() - 5;
			var _7d = _79.resizeHandle == "right"
					? (e.pageX > p2)
					: (_79.resizeHandle == "left"
							? (e.pageX < p1)
		...
		var _7f = _79.resizeHandle == "right"
				? "e"
		...
		_7b.each(function() {
			$(this).resizable({
				...
				onStartResize : function(e) {
					...
					if (!_77.proxy) {
						_77.proxy = $("<div class=\"datagrid-resize-proxy\"></div>")
								.appendTo(dc.view);
					}
					_77.proxy.css({
	...
	function _8c(_8d, _8e) {
		...
		_8e = _8e || {};
		var _91 = {
			sortName : _90.sortName,
			sortOrder : _90.sortOrder
		};
	...
	function _9a(_9b) {
		...
		function _a0() {
			...
			var _a5 = _9e.width() - _9e.find("table").width()
					- _9d.scrollbarSize + _9c.leftWidth;
			var _a6 = _a5 / _a1;
			if (!_9d.showHeader) {
				_a4.hide();
			}
		...
		function _9f() {
			...
			$.map(_a9, function(_aa) {
						...
						if (String(col.width || "").indexOf("%") >= 0) {
							var _ab = $.parser.parseValue("width", col.width,
									dc.view, _9d.scrollbarSize)
									- col.deltaWidth;
							if (_ab > 0) {
								col.boxWidth = _ab;
								_a8 = true;
	...
	function _ac(_ad, _ae) {
		...
		tmp.remove();
		function _1c(_b3) {
			var _b4 = dc.view.find("div.datagrid-header td[field=\"" + _b3
					+ "\"] div.datagrid-cell");
			_b4.css("width", "");
			...
			var _b5 = Math.max(_b6("header"), _b6("allbody"), _b6("allfooter"))
					+ 1;
			...
			function _b6(_b7) {
				...
				if (_b7 == "header") {
					...
					_b0.finder.getTr(_ad, 0, _b7).find("td[field=\"" + _b3
				...
				return _b8;
				function _b9(_ba) {
					return _ba.is(":visible") ? _ba._outerWidth() : tmp
							.html(_ba.html())._outerWidth();
				};
			};
		};
	};
	function _bb(_bc, _bd) {
		...
		function fix(_c3) {
			var col = _74(_bc, _c3);
			if (col.cellClass) {
				_be.ss.set("." + col.cellClass, col.boxWidth ? col.boxWidth
								+ "px" : "auto");
			}
		};
	};
		...
		if (tr.length) {
			...
			if (top < 0) {
				...
				if (top + tr._outerHeight() > _102.height() - 18) {
					_102.scrollTop(_102.scrollTop() + top + tr._outerHeight()
							- _102.height() + 18);
				}
			}
		}
	...
	function _104(_105, _106) {
		...
		opts.finder.getTr(_105, _107.highlightIndex)
	...
	function _117(_118, _119) {
		...
		opts.finder.getTr(_118, "", "allbody")
	...
	function _10e(_11e, _11f) {
		...
		opts.finder.getTr(_11e, "", "selected")
	...
	function _11c(_12e, _12f) {
		...
		var bck = opts.finder.getTr(_12e, "", "allbody")
	...
	function _122(_131, _132) {
		...
		var dc = _133.dc;
		var hck = dc.header1.add(dc.header2).find("input[type=checkbox]");
		var bck = opts.finder.getTr(_131, "", "checked")
				.removeClass("datagrid-row-checked")
				.find("div.datagrid-cell-check input[type=checkbox]");
	...
	function _161(_162, _163) {
		...
		$(_162).datagrid("getPager").pagination("refresh", {
					total : data.total
				});
	};
	function _167(_168, _169) {
		...
		_16a.push(_169.row);
		$(_168).datagrid("getPager").pagination("refresh", {
					total : data.total
				});
	};
	...
	function _187(_188, _189) {
		...
		var tr = opts.finder.getTr(_188, (_189.index != undefined
						? _189.index
						: _189.id), _189.type);
		if (!tr.length) {
			return;
		...
		function _193(name) {
			...
			return {
				init : function(_195, _196) {
					var _197 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
							.appendTo(_195);
	...
	var _19e = $.extend({},
			_190(["text", "textbox", "numberbox", "numberspinner", "combobox",
					"combotree", "combogrid", "datebox", "datetimebox",
					"timespinner", "datetimespinner"]), {
				textarea : {
					init : function(_19f, _1a0) {
						var _1a1 = $("<textarea class=\"datagrid-editable-input\"></textarea>")
								.appendTo(_19f);
						return _1a1;
					},
	...
	$.fn.datagrid.parseOptions = function(_1e4) {
		var t = $(_1e4);
		return $.extend({}, $.fn.panel.parseOptions(_1e4), $.parser
						.parseOptions(_1e4, ["url", "toolbar", "idField",
										"sortName", "sortOrder",
	...
	$.fn.datagrid.parseData = function(_1e5) {
		...
		var _1e6 = t.datagrid("getColumnFields", true).concat(t.datagrid(
	...
	var _1e7 = {
		render : function(_1e8, _1e9, _1ea) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				_1ed.push("<tr id=\"" + _1f1 + "\" datagrid-row-index=\"" + i
						+ "\" " + cls + " " + _1f0 + ">");
				_1ed.push(this.renderRow.call(this, _1e8, _1ec, _1ea, i,
						rows[i]));
				_1ed.push("</tr>");
			}
		...
		renderFooter : function(_1f2, _1f3, _1f4) {
			...
			for (var i = 0; i < rows.length; i++) {
				_1f6.push("<tr class=\"datagrid-row\" datagrid-row-index=\""
						+ i + "\">");
				_1f6.push(this.renderRow.call(this, _1f2, _1f5, _1f4, i,
						rows[i]));
				_1f6.push("</tr>");
			}
		...
		updateRow : function(_204, _205, row) {
			...
			function _208(_209) {
				...
				var _20b = tr
						.find("div.datagrid-cell-check input[type=checkbox]")
						.is(":checked");
				tr.html(this.renderRow.call(this, _204, _20a, _209, _205,
						rows[_205]));
		...
		onAfterRender : function(_220) {
			...
			if (opts.showFooter) {
				var _221 = $(_220).datagrid("getPanel")
