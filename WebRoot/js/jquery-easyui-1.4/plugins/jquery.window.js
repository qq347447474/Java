...
(function($) {
	...
	function _5(_6, _7) {
		...
		if (_8.inline) {
			...
			_8.left = Math.ceil(($(window)._outerWidth() - _9) / 2
					+ $(document).scrollLeft());
		}
		if (_7) {
			_1(_6);
	...
	function _b(_c, _d) {
		...
		if (_e.inline) {
			...
			_e.top = Math.ceil(($(window)._outerHeight() - _f) / 2
					+ $(document).scrollTop());
		}
		if (_d) {
			_1(_c);
	...
	function _11(_12) {
		...
		var win = $(_12).panel($.extend({}, _13.options, {
					...
					bodyCls : "window-body "
							+ (_14.noheader ? "window-body-noheader" : ""),
		...
		if (_14.modal == true) {
			_13.mask = $("<div class=\"window-mask\"></div>")
					.insertAfter(_13.window);
			_13.mask.css({
						width : (_14.inline
								? _13.mask.parent().width()
								: _18().width),
						height : (_14.inline
								? _13.mask.parent().height()
								: _18().height),
						display : "none"
					});
		}
		...
		if (_14.shadow == true) {
			_13.shadow = $("<div class=\"window-shadow\"></div>")
					.insertAfter(_13.window);
			_13.shadow.css({
						display : "none"
					});
	...
	function _19(_1a) {
		...
		_1b.window.draggable({
					...
					onStartDrag : function(e) {
						if (_1b.mask) {
							_1b.mask.css("z-index",
									$.fn.window.defaults.zIndex++);
						}
						if (_1b.shadow) {
							_1b.shadow.css("z-index",
									$.fn.window.defaults.zIndex++);
						}
						_1b.window
								.css("z-index", $.fn.window.defaults.zIndex++);
						if (!_1b.proxy) {
							_1b.proxy = $("<div class=\"window-proxy\"></div>")
									.insertAfter(_1b.window);
						}
						_1b.proxy.css({
									display : "none",
									zIndex : $.fn.window.defaults.zIndex++,
		...
		_1b.window.resizable({
			disabled : _1b.options.resizable == false,
			onStartResize : function(e) {
				if (_1b.pmask) {
					_1b.pmask.remove();
				}
				_1b.pmask = $("<div class=\"window-proxy-mask\"></div>")
						.insertAfter(_1b.window);
				_1b.pmask.css({
							zIndex : $.fn.window.defaults.zIndex++,
							left : e.data.left,
	...
	$.fn.window.parseOptions = function(_23) {
		return $.extend({}, $.fn.panel.parseOptions(_23), $.parser
						.parseOptions(_23, [{
											draggable : "boolean",
											resizable : "boolean",
											shadow : "boolean",
