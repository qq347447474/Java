...
(function($) {
	function _1(_2) {
		...
		if (_3.toolbar) {
			if ($.isArray(_3.toolbar)) {
				...
				var _5 = $("<div class=\"dialog-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>")
						.appendTo(_4);
				var tr = _5.find("tr");
	...
	function _a(_b, _c) {
		...
		tb.insertBefore(_b).css({
					position : "relative",
					borderTopWidth : (_e ? 1 : 0),
					top : (_e ? tb.length : 0)
				});
		bb.insertAfter(_b).css({
					position : "relative",
					top : -1
				});
	...
	$.fn.dialog.parseOptions = function(_16) {
		return $.extend({}, $.fn.window.parseOptions(_16), $.parser
						.parseOptions(_16, ["toolbar", "buttons"]));
	};
