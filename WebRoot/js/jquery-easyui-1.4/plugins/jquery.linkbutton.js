...
(function($) {
	function _1(_2, _3) {
		...
		if (_4.width || _4.height || _4.fit) {
			...
			_8.css("margin-top", parseInt((_6.height() - _8.height()) / 2)
							+ "px");
			_6.insertAfter(_5);
			_5.remove();
		}
	...
	function _9(_a) {
		...
		if (_b.iconCls) {
			$("<span class=\"l-btn-icon\">&nbsp;</span>").addClass(_b.iconCls)
					.appendTo(_c);
	...
	function _e(_12, _13) {
		...
		if (_13) {
			...
			_15.plain
					? $(_12).addClass("l-btn-disabled l-btn-plain-disabled")
					: $(_12).addClass("l-btn-disabled");
		} else {
			_15.disabled = false;
			if (_14.href) {
	...
	$.fn.linkbutton.parseOptions = function(_1c) {
		var t = $(_1c);
		return $.extend({}, $.parser.parseOptions(_1c, ["id", "iconCls",
