...
(function($) {
	...
	function _22(_23) {
		...
		cc.children("div").each(function() {
			var _25 = $.extend({}, $.parser.parseOptions(this), {
	...
	function _27(_28, pp, _29) {
		...
		pp.panel($.extend({}, {
					...
					onExpand : function() {
						...
						_2a.onSelect.call(_28, $(this).panel("options").title,
								_18(_28, this));
					},
					...
					onCollapse : function() {
						...
						_2a.onUnselect.call(_28,
								$(this).panel("options").title, _18(_28, this));
					}
				}));
