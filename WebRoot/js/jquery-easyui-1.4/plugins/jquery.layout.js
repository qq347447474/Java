...
(function($) {
		...
		if (pp.panel("options").split) {
			...
			_1f.resizable($.extend({}, {
				...
				onStartResize : function(e) {
					...
					if (dir == "north") {
						pos.top = parseInt(_1f.css("top")) + _1f.outerHeight()
								- _21.height();
				...
				onResize : function(e) {
					if (dir == "north" || dir == "south") {
						...
						_25.css("top", e.pageY - $(_18).offset().top
										- _25.height() / 2);
					} else {
						var _25 = $(">div.layout-split-proxy-h", _18);
						_25.css("left", e.pageX - $(_18).offset().left
										- _25.width() / 2);
					}
					return false;
				},
	...
	function _26(_27, _28) {
		...
		if (_29[_28].length) {
			...
			_29[_28] = $();
			var _2a = "expand" + _28.substring(0, 1).toUpperCase()
					+ _28.substring(1);
			if (_29[_2a]) {
	...
	function _2b(_2c, _2d, _2e) {
		...
		var _31 = "expand" + _2d.substring(0, 1).toUpperCase()
				+ _2d.substring(1);
		if (!_2f[_31]) {
			_2f[_31] = _32(_2d);
				...
				if (_2d == "west") {
					...
					if (_2d == "north") {
						...
						if (!_a(_2f.expandNorth)) {
							hh += _3b - _38
									+ ((_30.split || !_30.border) ? 1 : 0);
						}
						_2f.east.add(_2f.west).add(_2f.expandEast)
								.add(_2f.expandWest).panel("resize", {
											top : _38 - 1,
											height : hh
										});
						return {
	...
	function _3c(_3d, _3e) {
		...
		var _41 = "expand" + _3e.substring(0, 1).toUpperCase()
				+ _3e.substring(1);
		if (_3f[_41]) {
			_3f[_41].panel("close");
	...
	$.fn.layout = function(_48, _49) {
		...
		return this.each(function() {
					...
					if (_4a) {
						...
						var _4b = $.extend({}, $.fn.layout.defaults,
								$.fn.layout.parseOptions(this), _48);
						$.data(this, "layout", {
									options : _4b,
									panels : {
										center : $(),
	...
	$.fn.layout.parsePanelOptions = function(_53) {
		var t = $(_53);
		return $.extend({}, $.fn.panel.parseOptions(_53), $.parser
						.parseOptions(_53, ["region", {
											split : "boolean",
