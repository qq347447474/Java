...
(function($) {
		...
		$(_3).datagrid($.extend({}, _5, {
					...
					onClickCell : function(_6, _7, _8) {
						...
						if (_5.editIndex != _6 && _9.editor) {
							var _a = $(this).datagrid("getColumnOption",
									"value");
							_a.editor = _9.editor;
							_c(_1);
	...
	$.fn.propertygrid = function(_12, _13) {
		...
		return this.each(function() {
					...
					if (_15) {
						...
						var _16 = $.extend({}, $.fn.propertygrid.defaults,
								$.fn.propertygrid.parseOptions(this), _12);
						_16.frozenColumns = $.extend(true, [],
								_16.frozenColumns);
	...
	$.fn.propertygrid.parseOptions = function(_17) {
		return $.extend({}, $.fn.datagrid.parseOptions(_17), $.parser
						.parseOptions(_17, [{
											showGroup : "boolean"
										}]));
	};
	var _18 = $.extend({}, $.fn.datagrid.defaults.view, {
		...
		renderGroup : function(_1e, _1f, _20, _21) {
			...
			_25.push("<tr>");
			if ((_21 && (_23.rownumbers || _23.frozenColumns.length))
					|| (!_21 && !(_23.rownumbers || _23.frozenColumns.length))) {
				_25
			...
			for (var j = 0; j < _20.rows.length; j++) {
				var css = _23.rowStyler ? _23.rowStyler.call(_1e, _26,
						_20.rows[j]) : "";
				var _27 = "";
				var _28 = "";
				...
				var cls = "class=\"datagrid-row "
						+ (_26 % 2 && _23.striped ? "datagrid-row-alt " : " ")
						+ _27 + "\"";
				var _29 = _28 ? "style=\"" + _28 + "\"" : "";
				var _2a = _22.rowIdPrefix + "-" + (_21 ? 1 : 2) + "-" + _26;
				_25.push("<tr id=\"" + _2a + "\" datagrid-row-index=\"" + _26
						+ "\" " + cls + " " + _29 + ">");
				_25.push(this.renderRow.call(this, _1e, _24, _21, _26,
						_20.rows[j]));
				_25.push("</tr>");
				_26++;
			}
		...
		bindEvents : function(_2b) {
			...
			_2d.unbind("click").bind("click", function(e) {
				...
				if (_2f.length) {
					var _30 = _2f.closest("div.datagrid-group")
							.attr("group-index");
	...
	$.extend($.fn.datagrid.methods, {
				expandGroup : function(jq, _3e) {
					return jq.each(function() {
								...
								var _40 = _3f.find(_3e != undefined
								...
								if (_41.hasClass("datagrid-row-expand")) {
									_41.removeClass("datagrid-row-expand")
				...
				collapseGroup : function(jq, _42) {
					return jq.each(function() {
								...
								var _44 = _43.find(_42 != undefined
										? "div.datagrid-group[group-index=\""
												+ _42 + "\"]"
										: "div.datagrid-group");
								var _45 = _44
								...
								if (_45.hasClass("datagrid-row-collapse")) {
									_45.removeClass("datagrid-row-collapse")
