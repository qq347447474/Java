...
(function($) {
	...
	function _11(_12) {
		...
		function _1c(_28, _29) {
			...
			_2a.removeClass("tree-dnd-yes tree-dnd-no").addClass(_29
					? "tree-dnd-yes"
					: "tree-dnd-no");
		};
	...
	function _4d(_4e, ul, _4f, _50) {
		...
		if (!_50) {
			...
			if (_54) {
				_54.children
						? _54.children = _54.children.concat(_4f)
						: _54.children = _4f;
			} else {
	...
	function _5d(_5e, ul, _5f) {
		...
		var _65 = $(ul).children("li:last").children("div.tree-node")
				.addClass("tree-node-last");
		_65.children("span.tree-join").removeClass("tree-join")
	...
	function _a2(_a3, _a4) {
		...
		if (_a5) {
			if (!_a5.children || !_a5.children.length) {
				var _a6 = $(_a5.target);
				_a6.find(".tree-icon").removeClass("tree-folder")
						.addClass("tree-file");
	...
	var _11a = {
		render : function(_11b, ul, data) {
			...
			var _11c = $(ul).prev("div.tree-node")
