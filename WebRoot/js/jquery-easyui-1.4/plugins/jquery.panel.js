...
(function($) {
	...
	function _3(_4, _5) {
		...
		if (!isNaN(parseInt(_7.height))) {
			...
			_a.css("height", "");
			var _b = $.parser
					.parseValue("minHeight", _7.minHeight, _8.parent());
			var _c = $.parser
					.parseValue("maxHeight", _7.maxHeight, _8.parent());
	...
	function _17(_18) {
		...
		function _1c() {
			if (_1a.tools && typeof _1a.tools == "string") {
				_1b.find(">div.panel-header>div.panel-tool .panel-tool-a")
						.appendTo(_1a.tools);
			}
			_1(_1b.children("div.panel-header"));
			if (_1a.title && !_1a.noheader) {
				var _1f = $("<div class=\"panel-header\"></div>")
						.prependTo(_1b);
				var _20 = $("<div class=\"panel-title\"></div>")
						.html(_1a.title).appendTo(_1f);
				if (_1a.iconCls) {
					_20.addClass("panel-with-icon");
					$("<div class=\"panel-icon\"></div>").addClass(_1a.iconCls)
							.appendTo(_1f);
				}
					...
					if ($.isArray(_1a.tools)) {
						...
						$(_1a.tools).children().each(function() {
							$(this).addClass($(this).attr("iconCls"))
									.addClass("panel-tool-a").appendTo(_21);
						});
					}
				}
				if (_1a.collapsible) {
					$("<a class=\"panel-tool-collapse\" href=\"javascript:void(0)\"></a>")
							.appendTo(_21).bind("click", function() {
	...
	function _23(_24, _25) {
		...
		if (!_26.isLoaded || !_27.cache) {
			...
			if (_27.loadingMessage) {
				$(_24).html($("<div class=\"panel-loading\"></div>")
						.html(_27.loadingMessage));
			}
	...
	function _36(_40, _41) {
		...
		var _45 = _43.children("div.panel-header")
	...
	function _46(_47, _48) {
		...
		var _4c = _4a.children("div.panel-header")
				.find("a.panel-tool-collapse");
	...
	$.fn.panel = function(_5f, _60) {
		...
		return this.each(function() {
					...
					if (_61) {
						...
						_62 = $.extend({}, $.fn.panel.defaults, $.fn.panel
										.parseOptions(this), _5f);
						$(this).attr("title", "");
						_61 = $.data(this, "panel", {
									options : _62,
									panel : _13(this),
	...
	$.fn.panel.parseOptions = function(_70) {
		var t = $(_70);
		return $.extend({}, $.parser.parseOptions(_70, ["id", "width",
