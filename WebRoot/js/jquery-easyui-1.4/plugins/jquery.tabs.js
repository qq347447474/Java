...
(function($) {
	...
	function _c(_d) {
		...
		if (_e.tools) {
			if (typeof _e.tools == "string") {
				...
				var _10 = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
						.appendTo(_f);
				var tr = _10.find("tr");
	...
	function _12(_13, _14) {
		...
		if (_16.tabPosition == "left" || _16.tabPosition == "right") {
			...
			_1(_13);
			_18._size("height", isNaN(_16.height) ? "" : (_16.height - _17
							.outerHeight()));
	...
	function _28(_29) {
		...
		$(_29).children("div.tabs-header").unbind().bind("click", function(e) {
						...
						if ($(e.target).hasClass("tabs-scroller-right")) {
							...
							if (a.length) {
								...
								if (li.length) {
									...
									if (_2e.collapsible) {
										_2e.closed ? _40(_29, _2d) : _6a(_29,
												_2d);
									} else {
										_40(_29, _2d);
									}
			...
			if (li.length) {
				_2b.onContextMenu.call(_29, e, li.find("span.tabs-title")
								.html(), _2c(li));
			}
		});
		function _2c(li) {
	...
	function _35(_36, pp, _37) {
		...
		_39.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"
	...
	function _41(_42, _43) {
		...
		pp.panel($.extend({}, _43.options, {
					iconCls : (_43.options.icon ? _43.options.icon : undefined)
				}));
		...
		if (_46.tools) {
			var _49 = $("<span class=\"tabs-p-tool\"></span>").insertAfter(tab
					.find("a.tabs-inner"));
	...
	$.fn.tabs.methods = {
		...
		enableTab : function(jq, _86) {
			return jq.each(function() {
						$(this).tabs("getTab", _86).panel("options").tab
	...
	$.fn.tabs.parseOptions = function(_8c) {
		return $.extend({}, $.parser.parseOptions(_8c, ["tools",
