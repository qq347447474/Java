		...
		function _5(_9) {
			...
			if (_9.hasClass("menu-content")) {
				...
				_9.children("div").each(function() {
					var _a = $(this);
					var _b = $.extend({}, $.parser.parseOptions(this, ["name",
											"iconCls", "href", {
												separator : "boolean"
											}]), {
								disabled : (_a.attr("disabled")
										? true
										: undefined)
							});
					if (_b.separator) {
					...
					if (!_a.hasClass("menu-sep")) {
						...
						_a.empty().append($("<div class=\"menu-text\"></div>")
								.html(_c));
						if (_b.iconCls) {
	...
	function _3a(_3b, _3c) {
		...
		if (_3c.parent) {
			if (!_3c.parent.submenu) {
				var _3e = $("<div class=\"menu\"><div class=\"menu-line\"></div></div>")
						.appendTo("body");
				_3e.hide();
		...
		if (_3c.iconCls) {
			$("<div class=\"menu-icon\"></div>").addClass(_3c.iconCls)
					.appendTo(_3f);
		}
		if (_3c.id) {
			_3f.attr("id", _3c.id);
					...
					if (_4f) {
						...
						_4f = $.data(this, "menu", {
									options : $.extend({}, $.fn.menu.defaults,
											$.fn.menu.parseOptions(this), _4d)
								});
						_1(this);
					}
					$(this).css({
								left : _4f.options.left,
								top : _4f.options.top
							});
				});
	};
