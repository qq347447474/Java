...
(function($) {
	...
	function _7(_8) {
		...
		if (_a.buttonText || _a.buttonIcon) {
			var _b = $("<a href=\"javascript:void(0)\" class=\"textbox-button\"></a>")
					.prependTo(tb);
			_b.addClass("textbox-button-" + _a.buttonAlign).linkbutton({
						text : _a.buttonText,
						iconCls : _a.buttonIcon,
						onClick : function() {
	...
	function _6(_10, _11) {
		...
		btn.css({
					left : (_13.buttonAlign == "left" ? 0 : ""),
					right : (_13.buttonAlign == "right" ? 0 : "")
				});
		_16.css({
					left : (_13.iconAlign == "left"
							? (_13.buttonAlign == "left"
									? btn._outerWidth()
									: 0)
							: ""),
					right : (_13.iconAlign == "right"
							? (_13.buttonAlign == "right"
									? btn._outerWidth()
									: 0)
							: "")
				});
		_17.css({
					width : _13.iconWidth + "px",
					height : tb.height() + "px"
				});
		_15.css({
		...
		if (_13.multiline) {
			_15.css({
						paddingTop : (_10.style.paddingTop || ""),
						paddingBottom : (_10.style.paddingBottom || "")
					});
		...
		_15._outerWidth(tb.width() - _17.length * _13.iconWidth
				- btn._outerWidth());
		tb.insertAfter(_10);
		_13.onResize.call(_10, _13.width, _13.height);
		function _18(_1a) {
			return (_13.iconAlign == _1a ? _16._outerWidth() : 0)
					+ (_13.buttonAlign == _1a ? btn._outerWidth() : 0);
		};
	};
	function _1b(_1c) {
	...
	function _20(_21) {
		...
		tb.find(".textbox-button").linkbutton((_23.disabled || _23.readonly)
				? "disable"
				: "enable");
	};
	function _c(_2d, _2e) {
	...
	$.fn.textbox.parseOptions = function(_4d) {
		var t = $(_4d);
		return $.extend({}, $.fn.validatebox.parseOptions(_4d), $.parser
						.parseOptions(_4d, ["prompt", "iconCls", "iconAlign",
