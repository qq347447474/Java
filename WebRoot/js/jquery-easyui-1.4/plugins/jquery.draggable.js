...
(function($) {
	...
	function _12(e) {
		...
		_13.droppables.each(function() {
			...
			var p2 = _15.offset();
			if (e.pageX > p2.left && e.pageX < p2.left + _15.outerWidth()
					&& e.pageY > p2.top && e.pageY < p2.top + _15.outerHeight()) {
				if (!this.entered) {
	...
	function _16(e) {
		...
		function _1a() {
			...
			_17.droppables.each(function() {
						...
						var p2 = _1e.offset();
						if (e.pageX > p2.left
								&& e.pageX < p2.left + _1e.outerWidth()
								&& e.pageY > p2.top
	...
	$.fn.draggable = function(_1f, _20) {
		...
		return this.each(function() {
					...
					if (_22) {
						...
						_21 = $.extend({}, $.fn.draggable.defaults,
								$.fn.draggable.parseOptions(this), _1f || {});
					}
