...
(function($) {
	function _1(_2) {
		...
		_5.push({
					...
					handler : function(e) {
						...
						_6.searcher
								.call(e.data.target, t.searchbox("getValue"), t
												.searchbox("getName"));
					}
				});
		_7();
		...
		function _a(_10) {
			...
			_3.searchbox.find("input.textbox-value").attr("name",
					_10.name || _10.text);
			$(_2).searchbox("resize");
		};
	};
	...
	$.fn.searchbox.parseOptions = function(_1a) {
		var t = $(_1a);
		return $.extend({}, $.fn.textbox.parseOptions(_1a), $.parser
						.parseOptions(_1a, ["menu"]), {
				...
				inputEvents : $.extend({}, $.fn.textbox.defaults.inputEvents, {
							keydown : function(e) {
								if (e.keyCode == 13) {
									...
									_1b.searcher.call(e.data.target, t
