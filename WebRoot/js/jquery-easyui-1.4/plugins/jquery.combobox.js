...
(function($) {
	...
	function _1a(_21, _22, _23) {
		...
		_25.find("div.combobox-item-selected")
	...
	function _34(_35, q) {
		...
		if (_37.mode == "remote") {
			...
			_38.find("div.combobox-item-selected,div.combobox-item-hover")
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
						...
						_51.find("div.combobox-item-selected")
								.removeClass("combobox-item-selected");
					});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_56) {
		var t = $(_56);
		return $
				.extend({}, $.fn.combo.parseOptions(_56), $.parser
								.parseOptions(_56, ["valueField", "textField",
	...
	$.fn.combobox.parseData = function(_57) {
		...
		function _5b(el, _5c) {
			var t = $(el);
			var row = {};
			row[_59.valueField] = t.attr("value") != undefined ? t
					.attr("value") : t.text();
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		finder : {
			...
			getRow : function(_69, p) {
				...
				var _6b = (p instanceof jQuery) ? p.attr("id")
						.substr(_6a.itemIdPrefix.length + 1) : _2(_69, p);
