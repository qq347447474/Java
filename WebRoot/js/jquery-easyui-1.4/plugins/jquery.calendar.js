...
(function($) {
	...
	function _5(_15) {
		...
		if ($(_15).find(".calendar-menu-month-inner").is(":empty")) {
			...
			var t = $("<table class=\"calendar-mtable\"></table>")
					.appendTo($(_15).find(".calendar-menu-month-inner"));
			var idx = 0;
			for (var i = 0; i < 3; i++) {
				var tr = $("<tr></tr>").appendTo(t);
				for (var j = 0; j < 4; j++) {
					$("<td class=\"calendar-menu-month\"></td>")
							.html(_16.months[idx++]).attr("abbr", idx)
							.appendTo(tr);
				}
			}
	...
	function _21(_22, _23, _24) {
		...
		if (_2c.length < 7) {
			while (_2c.length < 7) {
				...
				_2c.unshift([_2b.getFullYear(), _2b.getMonth() + 1,
						_2b.getDate()]);
			}
		} else {
			var _2d = _2c[0];
			...
			for (var i = 1; i <= 7; i++) {
				...
				_29.unshift([_2b.getFullYear(), _2b.getMonth() + 1,
						_2b.getDate()]);
			}
			_28.unshift(_29);
		}
		...
		if (_28.length < 6) {
			...
			for (var i = 1; i <= 7; i++) {
				...
				_29
						.push([_2b.getFullYear(), _2b.getMonth() + 1,
								_2b.getDate()]);
			}
			_28.push(_29);
		}
	...
	function _e(_30) {
		...
		var now = new Date();
		var _32 = now.getFullYear() + "," + (now.getMonth() + 1) + ","
				+ now.getDate();
		var _33 = _31.current
				? (_31.current.getFullYear() + ","
						+ (_31.current.getMonth() + 1) + "," + _31.current
						.getDate())
				: "";
		...
		$(_30).find(".calendar-title span").html(_31.months[_31.month - 1]
				+ " " + _31.year);
		...
		moveTo : function(jq, _43) {
			return jq.each(function() {
						...
						if (_44.validator.call(this, _43)) {
							var _45 = _44.current;
							$(this).calendar({
										year : _43.getFullYear(),
										month : _43.getMonth() + 1,
										current : _43
									});
