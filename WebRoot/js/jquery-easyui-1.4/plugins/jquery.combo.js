...
(function($) {
	...
	function _1b(_1c) {
		...
		if (_1f.panel("options").closed) {
			_1f.panel("open").panel("resize", {
						width : (_20.panelWidth ? _20.panelWidth : _1e
								._outerWidth()),
		...
		function _21() {
			...
			if (_23 + _1f._outerWidth() > $(window)._outerWidth()
					+ $(document).scrollLeft()) {
				_23 = $(window)._outerWidth() + $(document).scrollLeft()
						- _1f._outerWidth();
			}
			if (_23 < 0) {
				_23 = 0;
		...
		function _22() {
			...
			if (top + _1f._outerHeight() > $(window)._outerHeight()
					+ $(document).scrollTop()) {
					...
					if (_4b) {
						...
						_4b = $.data(this, "combo", {
									options : $.extend({}, $.fn.combo.defaults,
											$.fn.combo.parseOptions(this), _48),
									previousText : ""
								});
	...
	$.fn.combo.parseOptions = function(_51) {
		var t = $(_51);
		return $.extend({}, $.fn.textbox.parseOptions(_51), $.parser
						.parseOptions(_51, ["separator", "panelAlign", {
											panelWidth : "number",
